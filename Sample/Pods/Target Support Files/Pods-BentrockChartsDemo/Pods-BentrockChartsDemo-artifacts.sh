...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/BentrockCharts/SDK/BentrockCharts.xcframework" "" "true" "ios-armv7_arm64/BentrockCharts.framework" "ios-i386_x86_64-simulator/BentrockCharts.framework"
fi
