...
Pod::Spec.new do |spec|
  ...
  spec.public_header_files = "SDK/Chart.xcframework/ios-armv7_arm64/Chart.framework/Headers/*.h"
  spec.source_files = "SDK/Chart.xcframework/ios-armv7_arm64/Chart.framework/Headers/*.h"
  spec.vendored_frameworks = "SDK/Chart.xcframework"
end
